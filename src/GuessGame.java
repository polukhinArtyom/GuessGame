public class GuessGame {
    ...
    // GuessGame содержит три переменных экземпляра для трёх объектов Player.
    Player p1;
    Player p2;
    Player p3;
    ...
    public void startGame(){
        ...
        // Объявляем три переменнные для хранения правильности или неправильности (true или false) ответов игроков.
        boolean p1isRight = false;
        boolean p2isRight = false;
        boolean p3isRight = false;

        // Создём число, которое игроки должны угадать.
        ...
        while (true) {
            ...
            // Если игрок угадал, то присваиваем соответствующей переменной значение
            // true (помните, что по умолчанию она хранит значение - false.
            ...
            // Если первый игрок, ИЛИ второй игрок, ИЛИ третий игрой угадал (оператор || означает ИЛИ)
